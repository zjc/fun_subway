...
public class FlutterWebviewPlugin implements MethodCallHandler {
    ...
    private static final String CHANNEL_NAME = "com.fun.framework.plugins/webview";

    public static void register(Activity activity, BinaryMessenger messenger) {
        channel = new MethodChannel(messenger, CHANNEL_NAME);
        FlutterWebviewPlugin instance = new FlutterWebviewPlugin(activity);
