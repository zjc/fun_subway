...
abstract class BaseModel {
  Future<Map<String,dynamic>> get(String partUrl, Map<String, Object> params) async {
  ...
  ResponseBean<T> newResponseBean<T>(String code,T data,String error_code,String error_reason){
    return new ResponseBean(code, data, error_code, error_reason);
  }
